    ...
    <div>
      ...
      <div className="dark:bg-neutral-900">
        <div className="w-[90vw] mt-10 mx-auto flex flex-col sm:flex-row ">
          <Image
            className="w-[100%] sm:w-[50%] sm:m-5 rounded-lg "
            src="/3644996.jpg"
            alt=""
            width={1200}
            height={800}
          ...
          <div className="flex flex-col justify-evenly w-full">
            <p className="m-5 text-2xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-6xl font-semibold">
              Let&apos;s start <br className="hidden sm:inline" /> Learning,{" "}
              {username}
            </p>
